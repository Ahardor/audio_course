...
type MockServiceClient interface {
	GetSoundFile(ctx context.Context, in *GetSoundFileRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *mockServiceClient) GetSoundFile(ctx context.Context, in *GetSoundFileRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/mock.v1.MockService/GetSoundFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MockServiceServer interface {
	GetSoundFile(context.Context, *GetSoundFileRequest) (*emptypb.Empty, error)
...
func (UnimplementedMockServiceServer) GetSoundFile(context.Context, *GetSoundFileRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSoundFile not implemented")
}
...
func _MockService_GetSoundFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSoundFileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MockServiceServer).GetSoundFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mock.v1.MockService/GetSoundFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MockServiceServer).GetSoundFile(ctx, req.(*GetSoundFileRequest))
	}
...
var MockService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mock.v1.MockService",
	HandlerType: (*MockServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetSoundFile",
			Handler:    _MockService_GetSoundFile_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "mock/api/mock_v1/service.proto",
}
